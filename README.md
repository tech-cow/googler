...
<body style="margin: 50px 20px;color: #333;font-family: 'Helvetica Neue','Hiragino Sans GB','WenQuanYi Micro Hei','Microsoft Yahei',sans-serif;">
  <div class="export-wrapper">
    <div style="font-size: 24px; padding: 20px 15px 0;">
      <div style="padding-bottom: 10px">🍻 cs</div>
      <div style="background: #e5e6e8; height: 1px; margin-bottom: 20px;"></div>
    </div>
    <ul style="list-style: disc outside;">
      <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">🍥 Interview</span></span>
        <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                    ...
                    <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                      ...
                      <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">Jose :</span></span>
                        <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                          ...
                          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">定义：&nbsp;</span>A singly linked list, in
                            its simplest form, is a collection of nodes that collectively form a linear sequence. Each Node stores a references to an object that is an element of the sequence, as well as a reference to the next node of the list.</span>
                          </li>
                          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">Head/Tail:</span>&nbsp;The list instance
                            maintains a member named<span class="bold" style="font-weight: bold;">&nbsp;head&nbsp;</span>that identifies the first node of the list. In some applications another member named<span class="bold" style="font-weight: bold;">&nbsp;tail&nbsp;</span>that
                          ...
                          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">Traversing:&nbsp;</span>This process is commonly
                            ...
                            <span class="bold" style="font-weight: bold;">pointer</span>&nbsp;to another node, the process of traversing a list is also known as&nbsp;<span class="bold" style="font-weight: bold;">link hopping</span>&nbsp;or&nbsp;
                            <span class="bold" style="font-weight: bold;">pointer hopping</span>.</span>
                          </li>
                          ...
                          <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">Insert Head：</span></span>
                            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                              ...
                              <li style="line-height: 22px;"><span class="content mubu-node" images="%5B%7B%22w%22%3A671%2C%22ow%22%3A1079%2C%22oh%22%3A603%2C%22id%22%3A%22353163401832de1%22%2C%22uri%22%3A%22document_image%2F500dede6-cf83-414b-938a-257630d20778-808326.jpg%22%7D%5D"
                                  style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">例：</span></span>
                              ...
                              <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">Insertion：</span></span>
                                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                                  ...
                                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">所以假如<span class="bold" style="font-weight: bold;">Search也经常使用</span>，Linked List相对Array
                                    <span class="bold" style="font-weight: bold;">并无优势</span>：</span>
                                    <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
          ...
          <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">Algorithm</span></span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
          ...
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">System Design</span></span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">领域扫盲：</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/donnemartin/system-design-primer" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/donnemartin/system-design-primer</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/binhnguyennus/awesome-scalability" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/binhnguyennus/awesome-scalability</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/shashank88/system_design" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/shashank88/system_design</a></span></li>
                </ul>
              </li>
              <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">实战问题：</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://legacy.gitbook.com/book/soulmachine/system-design/details" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://legacy.gitbook.com/book/soulmachine/system-design/details</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Engineering Blog</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Linkedin </span>
                    <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                      <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">分布式系统 </span>
                        <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  ...
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Dropbox:</span>
                    <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  ...
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">API设计原理：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/oldratlee/translations/blob/master/api-design-principles-from-qt/README.md" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/oldratlee/translations/blob/master/api-design-principles-from-qt/README.md</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">500行代码实现项目搭建： <a class="content-link" target="_blank" rel="noreferrer" href="http://aosabook.org/en/index.html" style="text-decoration: underline; opacity: 0.6; color: inherit;">http://aosabook.org/en/index.html</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">设计Redis：<a class="content-link" target="_blank" rel="noreferrer" href="http://origin.redisbook.com" style="text-decoration: underline; opacity: 0.6; color: inherit;">http://origin.redisbook.com</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">设计RESTful API: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/aisuhua/restful-api-design-references" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/aisuhua/restful-api-design-references</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">设计Compiler: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/jamiebuilds/the-super-tiny-compiler" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/jamiebuilds/the-super-tiny-compiler</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">设计DB：<a class="content-link" target="_blank" rel="noreferrer" href="http://www.open-open.com/code/view/1421500691156" style="text-decoration: underline; opacity: 0.6; color: inherit;">http://www.open-open.com/code/view/1421500691156</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">后端架构：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/xingshaocheng/architect-awesome" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/xingshaocheng/architect-awesome</a></span></li>
            </ul>
          </li>
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">面试准备：</span></span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">回答以下所有问题：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/arialdomartini/Back-End-Developer-Interview-Questions" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/arialdomartini/Back-End-Developer-Interview-Questions</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">饿了么知识面试大全：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/ElemeFE/node-interview/tree/master/sections/zh-cn" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/ElemeFE/node-interview/tree/master/sections/zh-cn</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">git遇到问题：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/k88hudson/git-flight-rules" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/k88hudson/git-flight-rules</a></span></li>
      ...
      <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">🍥<span class="bold" style="font-weight: bold;"> 代码提高</span></span>
        <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">资源：<a class="content-link" target="_blank" rel="noreferrer" href="http://www.allitebooks.com" style="text-decoration: underline; opacity: 0.6; color: inherit;">http://www.allitebooks.com</a></span></li>
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">pip</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">pyflakes: Debug</span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">bottle: micro-framwork</span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">pytest: Unittest framwork</span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">hypothesis: Generating test case automatically!</span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">mypy: Static type checking</span></li>
            </ul>
          </li>
          <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">方法论：</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
          ...
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">python进阶</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Standford Programming Paradigms:</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">第24课开始：<a class="content-link" target="_blank" rel="noreferrer" href="https://www.youtube.com/watch?v=_9XAlLofYwU&amp;index=23&amp;list=PL9D558D49CA734A02" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://www.youtube.com/watch?v=_9XAlLofYwU&amp;index=23&amp;list=PL9D558D49CA734A02</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Python Fucntional Programming:</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/igrishaev/f" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/igrishaev/f</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Coding Style：</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://www.youtube.com/watch?v=wf-BqAjZb8M&amp;list=PLaPo3v0SrxzPN93-Vc0w2qDC8NrdSoF4Z&amp;index=7" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://www.youtube.com/watch?v=wf-BqAjZb8M&amp;list=PLaPo3v0SrxzPN93-Vc0w2qDC8NrdSoF4Z&amp;index=7</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://www.youtube.com/watch?v=o0LohkA3UR4" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://www.youtube.com/watch?v=o0LohkA3UR4</a></span></li>
                </ul>
              </li>
              ...
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">python 用法cheatsheet：<a class="content-link" target="_blank" rel="noreferrer" href="https://www.pythonsheets.com/" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://www.pythonsheets.com/</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">python一些鲜为人知的东西：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/satwikkansal/wtfpython" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/satwikkansal/wtfpython</a></span></li>
            </ul>
          </li>
          <li class="collapsed" style="line-height: 22px;"><span class="content mubu-node collapsed" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">造轮子</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">kennethreitz</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">快速上手Flask： <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/kennethreitz/saythanks.io" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/kennethreitz/saythanks.io</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">500行代码：SQL records：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/kennethreitz/records" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/kennethreitz/records</a></span></li>
                </ul>
              </li>
          ...
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">效率提升</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">各类productivity app：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/hzlzh/Best-App" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/hzlzh/Best-App</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">录制terminal: asciinema rec</span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">python代码格式： $ pip install --upgrade autopep8 </span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">shell操作 $  pip install sh  （<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/amoffat/sh" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/amoffat/sh</a>）</span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">爬虫爬所有的文字：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/grangier/python-goose" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/grangier/python-goose</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">shell有用操作合集：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/alexanderepstein/Bash-Snippets" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/alexanderepstein/Bash-Snippets</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">实时监控python：livepython [program] [args...] </span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">自动搜寻错误信息：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/danrobinson/tracestack" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/danrobinson/tracestack</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">github自动化：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/FriendCode/gittle" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/FriendCode/gittle</a></span></li>
            </ul>
          </li>
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">博客/资源</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">偶像：</span></span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" color="#797ec9" style="color: rgb(121, 126, 201); line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Raymond Hettinger</span>
                    <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              ...
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">合集继续深度爬</span>：<a class="content-link" target="_blank"
                  rel="noreferrer" href="https://github.com/stanzhai/be-a-professional-programmer" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/stanzhai/be-a-professional-programmer</a></span>
              </li>
      ...
      <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">🍥 Github</span></span>
        <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">目前项目：</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"> marker</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">写个doc: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/mkdocs/mkdocs" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/mkdocs/mkdocs</a></span></li>
                  <li style="color: rgb(160, 160, 160); line-height: 22px;"><span class="content mubu-node finished" style="text-decoration: line-through; line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">手写一个V1.0，然后上传marker，实现基础功能</span></li>
                  <li style="color: rgb(160, 160, 160); line-height: 22px;"><span class="content mubu-node finished" style="text-decoration: line-through; line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">好的Readme收集</span>
                    <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                      ...
                      <li style="color: rgb(160, 160, 160); line-height: 22px;"><span class="content mubu-node finished" style="text-decoration: line-through; line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/alexanderepstein/Bash-Snippets" style="color: inherit; text-decoration: underline; opacity: 0.6;">https://github.com/alexanderepstein/Bash-Snippets</a></span></li>
                    </ul>
                  </li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">类似代码：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/bamos/python-scripts/blob/master/generate-readme.py" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/bamos/python-scripts/blob/master/generate-readme.py</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">CLI代码启发: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/h4ck3rk3y" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/h4ck3rk3y</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">把我的MD做成类似这样：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/donnemartin/haxor-news" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/donnemartin/haxor-news</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">实现fake data：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/joke2k/faker" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/joke2k/faker</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">录制terminal: asciinema rec</span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">stock</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">mongo进阶：<a class="content-link" target="_blank" rel="noreferrer" href="http://www.open-open.com/code/view/1425349118603" style="text-decoration: underline; opacity: 0.6; color: inherit;">http://www.open-open.com/code/view/1425349118603</a></span></li>
                </ul>
              </li>
            </ul>
          </li>
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">ideas</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">GraphQL扫盲：<a class="content-link" target="_blank" rel="noreferrer" href="https://juejin.im/entry/59b623fbf265da065814f8b4" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://juejin.im/entry/59b623fbf265da065814f8b4</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">写一个类似于这样的tool总和：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/sindresorhus/quick-look-plugins" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/sindresorhus/quick-look-plugins</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">逆天了。把网站编程API: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/gaojiuli/toapi" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/gaojiuli/toapi</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">一堆有趣的python代码：</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/agarwalsarthak121/web_crawlers" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/agarwalsarthak121/web_crawlers</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/bamos/python-scripts" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/bamos/python-scripts</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">迅速搭建REST Mongo Wrapper:&nbsp;<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/pyeve/eve" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/pyeve/eve</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">用Twitter API做点事：&nbsp;<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/tweepy/tweepy" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/tweepy/tweepy</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">一堆Python的Project Ideas:&nbsp;<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/tuvtran/project-based-learning" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/tuvtran/project-based-learning</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">AwesomeAPI大全 <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/SkiaWorks/Awesome_APIs" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/SkiaWorks/Awesome_APIs</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">用前端UI搭建我的收费网站：</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/jgthms/bulma" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/jgthms/bulma</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://milligram.io/" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://milligram.io/</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">搭建个人的wiki主页：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/tankywoo/simiki" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/tankywoo/simiki</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Tensorflow学习：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/vahidk/EffectiveTensorflow" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/vahidk/EffectiveTensorflow</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">扫盲：</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">panda：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/hangsz/pandas-tutorial" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/hangsz/pandas-tutorial</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">pytorch：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/chenyuntc/pytorch-book" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/chenyuntc/pytorch-book</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">脑洞打开的各种爬虫: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/facert/awesome-spider" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/facert/awesome-spider</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">做一个聊天机器人：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/warmheartli/ChatBotCourse" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/warmheartli/ChatBotCourse</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">项目思考：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/karan/Projects" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/karan/Projects</a></span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">参考：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/karan/Projects-Solutions" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/karan/Projects-Solutions</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">code2pdf&nbsp;<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/tushar-rishav/code2pdf/tree/master/Code2pdf" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/tushar-rishav/code2pdf/tree/master/Code2pdf</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><span class="bold" style="font-weight: bold;">个人主页：</span></span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="http://hishark.cc" style="text-decoration: underline; opacity: 0.6; color: inherit;">http://hishark.cc</a> 极简静态</span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">做一个类似这样的头像generator: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/saikatbsk/Vincent-AI-Artist" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/saikatbsk/Vincent-AI-Artist</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">Amazon Echo: <a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/johnwheeler/flask-ask" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/johnwheeler/flask-ask</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">写一个flask网站：</span>
                <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/realpython/discover-flask" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/realpython/discover-flask</a></span></li>
                  <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;"><a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/hustlzp/Flask-Boost" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/hustlzp/Flask-Boost</a></span></li>
                </ul>
              </li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">爬虫框架：<a class="content-link" target="_blank" rel="noreferrer" href="https://github.com/lorien/grab" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://github.com/lorien/grab</a></span></li>
            </ul>
          </li>
          <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">配件升级：</span>
            <ul class="children" style="list-style: disc outside; padding-bottom: 4px;">
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">键盘：<a class="content-link" target="_blank" rel="noreferrer" href="http://www.smartimports.net/pfu-happy-hacking-keyboard-professional-bt-bluetooth-in-white/" style="text-decoration: underline; opacity: 0.6; color: inherit;">http://www.smartimports.net/pfu-happy-hacking-keyboard-professional-bt-bluetooth-in-white/</a></span></li>
              <li style="line-height: 22px;"><span class="content mubu-node" style="line-height: 22px; min-height: 22px; font-size: 14px; display: inline-block; vertical-align: top;">鼠标：<a class="content-link" target="_blank" rel="noreferrer" href="https://www.amazon.com/Apple-Magic-Trackpad-2-MJ2R2LL/dp/B016QO5YWC/ref=sr_1_7?ie=UTF8&amp;qid=1525899804&amp;sr=8-7&amp;keywords=touchpad" style="text-decoration: underline; opacity: 0.6; color: inherit;">https://www.amazon.com/Apple-Magic-Trackpad-2-MJ2R2LL/dp/B016QO5YWC/ref=sr_1_7?ie=UTF8&amp;qid=1525899804&amp;sr=8-7&amp;keywords=touchpad</a></span></li>
            </ul>
          </li>
        </ul>
      </li>
